...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_query_string__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__login__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__general__ = __webpack_require__(39);
...
class App extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
  constructor() {
    const parsed = __WEBPACK_IMPORTED_MODULE_2_query_string___default.a.parse(location.search);
    super();
    this.state = {
      user: null,
      log: parsed.log
  ...
  renderModule() {
    if (!this.state.log) {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__login__["a" /* default */], { login: this.login });
    } else {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__general__["a" /* default */], null);
    }
  }
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'a',
                    { href: '/auth/google' },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { 'class': 'fab fa-google' }),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'span',
                        null,
                        'oogle'
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__filter__ = __webpack_require__(59);





class GeneralRoom extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
    ...
    searchVideos() {
        __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/search?q=' + this.state.q).then(res => {
    ...
    searchMessage() {
        ...
        __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/messages?pageToken=' + this.state.messagePageToken).then(res => {
            var timerID;
            ...
            if (pollingIntervalMillis) {
                ...
                timerID = setTimeout(this.searchMessage, pollingIntervalMillis);
            }
    ...
    handleOnSelectVideo(video) {
        ...
        __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/liveChat?videoId=' + video.id.videoId).then(res => {
            var videos = res.data.videos;
            var pageToken = res.data.nextPageToken;
            var total = res.data.totalResults;
            var resultPerPage = res.data.resultsPerPage;
    ...
    renderStreamModule() {
        if (!this.state.selectedVideo) {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__stream__["a" /* default */], { video: this.state.selectedVideo, messages: this.state.messages, onChangefilterUsername: this.onChangefilterUsername, filterMessages: this.filterMessages });
        }
    }
    ...
    renderFilterModule() {
        if (!this.state.filterMessages || this.state.filterMessages.length < 1) {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__filter__["a" /* default */], { filterMessages: this.state.filterMessages, filterUser: this.state.filterUser, removeFilter: this.removeFilter });
        }
    }
    ...
    render() {
        const videos = this.state.videos.map(video => {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { key: video.id.videoId, className: selected ? "row selected" : "row" },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    { className: "width-70 text-left" },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "label",
                        null,
                        video.title
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    { className: "width-30 text-right" },
                    selected ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "label",
                        null,
                        "Watching"
                    ) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "button",
                        { onClick: () => this.handleOnSelectVideo(video) },
                        "Watch"
                    )
                )
            );
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "video-container video-background" },
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "label",
                            null,
                            "Select a Stream Video"
                        )
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                        { className: "row width-30 text-right" },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "form",
                            { onSubmit: this.handleSearchAttemptSubmit },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { value: this.state.q, onChange: ev => this.setState({ q: ev.target.value }) }),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "submit", className: "", value: "Go!" })
                        )
                    )
                ),
                videos
...
/* harmony default export */ __webpack_exports__["a"] = (GeneralRoom);
...
class Stream extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
    ...
    renderVideo() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("iframe", { key: this.props.video.id.videoId, width: "600", height: "350", src: "https://www.youtube.com/embed/live_stream?autoplay=1&channel=" + this.props.video.channelId, frameBorder: "0", allowFullScreen: true });
    }
    render() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                        { className: "width-70 text-left" },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { value: this.props.filterUsername, onChange: this.props.onChangefilterUsername })
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                        { className: "width-30 text-right" },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { onClick: this.props.filterMessages, type: "submit", className: "", value: "Filter!" })
                    )
                )
            )
        );
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    { className: "width-30 text-right" },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { onClick: this.props.removeFilter, type: "submit", className: "", value: "Close" })
                )
            ),
            messages
        );
